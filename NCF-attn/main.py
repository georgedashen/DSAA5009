...
############################## PREPARE DATASET ##########################
train_data, test_data, user_num ,item_num, train_mat = data_utils.load_all(args.trainN, args.testN, args.test_itemN)
...
for epoch in range(args.epochs):
    ...
    print("Evaluating ...")
    model.eval()
    HR, NDCG = evaluate.metrics(model, test_loader, args) #very slow, not parallel
